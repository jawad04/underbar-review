(function() {
  ...
  describe('Part I', function() {
    ...
    describe('reduce', function() {
      ...
      it('tests if the accumulator binds to the third argumentFill me in with a description of the behavior this test is checking for', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
